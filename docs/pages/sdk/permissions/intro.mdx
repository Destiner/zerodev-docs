...
- [Sudo policy](/sdk/permissions/policies/sudo): you can do anything
- [Call policy](/sdk/permissions/policies/call): you can only call certain contracts or functions (and only with certain params)
- [Gas policy](/sdk/permissions/policies/gas): you can only spend up to X amount of gas
- [Signature policy](/sdk/permissions/policies/signature): you can only sign certain messages
- [Rate limit policy](/sdk/permissions/policies/rate-limit): you can only send UserOps within a given rate limit
- [Timestamp policy](/sdk/permissions/policies/timestamp): you can only send UserOps within certain timeframes
...
- [Learn to automate transactions for users with permissions.](/sdk/permissions/transaction-automation)